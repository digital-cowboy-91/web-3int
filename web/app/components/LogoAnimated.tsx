...
const LogoAnimated = ({ color, width, height, className, onClick }: Props) => {
      ...
      <g transform="matrix(0.259354,0,0,0.259354,-58.1586,46.6604)">
        ...
        <g transform="matrix(3.85573,0,0,3.85573,224.244,-179.91)">
          <motion.path
            ...
            fill="transparent"
            variants={animate}
            d="M62.638,118.19L62.638,38.095C62.638,38.095 62.638,34.617 66.346,34.617C70.055,34.617 70.055,38.095 70.055,38.095L70.055,114.871C70.055,114.871 70.055,118.19 73.783,118.19C77.512,118.19 77.512,114.871 77.512,114.871L77.512,5.12C77.512,5.12 77.512,1.771 73.783,1.771C70.055,1.771 70.055,5.12 70.055,5.12L70.055,11.362C70.055,11.362 70.055,14.835 66.346,14.835C62.638,14.835 62.638,11.362 62.638,11.362L62.638,1.771"
          />
        </g>
        <g transform="matrix(3.85573,0,0,3.85573,224.244,-179.91)">
          <motion.path
